...
<body>
    ...
    <div class="row">
        ...
        <table class="table">
            ...
            <tr>
                <td>
                    <input class="btn btn-block" type="button" value="Editar">
                </td>
            </tr>
        
            <tr>
                <td>
                    <input class="btn btn-block" type="button" value="Eliminar">
                </td>
            </tr>
        
            <tr>
                <td>
                    <input class="btn btn-block" type="button" value="Historial">
                </td>
            </tr>
        
            <tr>
                <td>
                    <input class="btn btn-block" type="button" value="Compartir">
                </td>
            </tr>
